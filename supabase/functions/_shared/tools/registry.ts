      ...
      properties: {
        ...
        fields: {
          ...
          items: {
            ...
            properties: {
              label: { type: "string" },
              type: { type: "string", enum: ["text", "number", "date", "dropdown", "textarea", "checkbox", "computed"], description: "Use \"computed\" for an auto-calculated field whose value comes from a formula over OTHER fields." },
      ...
      properties: {
        ...
        fields: {
          ...
          items: {
            ...
            properties: {
              label: { type: "string" },
              type: { type: "string", enum: ["text", "number", "date", "dropdown", "textarea", "checkbox", "computed"], description: "Use \"computed\" for an auto-calculated field." },
              required: { type: "boolean" },
              section: { type: "string" },
