  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        production_mapping: { type: "object", additionalProperties: { type: "string" }, description: "Only for a slot form (slot_key set): make its data feed the production dashboards by mapping production values to this form's field LABELS. Keys depend on the slot — e.g. for sewing_end_of_day: good_output, reject, rework, manpower, hours, ot_hours; for *_targets: per_hour_target, manpower, hours, ot_hours; cutting: day_cutting, day_input, manpower, marker_capacity, lay_capacity, cutting_capacity, hours; finishing_daily_output: qc_pass, poly, carton, manpower, hours. Example: {\"good_output\": \"Line output (Production)\", \"manpower\": \"Daily Manpower\", \"hours\": \"Worked Hours\"}. Line and PO are detected automatically from the form's line/PO picker fields." },
  ...
  },
  {
    ...
    input_schema: {
      ...
      properties: {
        ...
        production_mapping: { type: "object", additionalProperties: { type: "string" }, description: "Set/replace the production mapping for a slot form so its data feeds the dashboards. Map production value keys to this form's field LABELS (keys depend on the slot, e.g. sewing_end_of_day: good_output, reject, rework, manpower, hours, ot_hours). Line and PO are auto-detected. Example: {\"good_output\": \"Line output (Production)\", \"manpower\": \"Daily Manpower\", \"hours\": \"Worked Hours\"}." },
